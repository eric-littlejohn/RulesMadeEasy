...
{
    /// <summary>
    /// An implementation of an <see cref="IValueEvaluator"/> for <see cref="ulong"/>s
    /// </summary>
    public class ULongValueEvaluator : IValueEvaluator
    {
        /// <summary>
        ...
        {
            var valueA = (ulong)objA;
            var valueB = (ulong)objB;
            ...
            switch (operation)
            {
                ...
                default:
                    throw new ConditionEvaluationException(ConditionEvaluationException.ExceptionCause.UnsupportedOperator,
                        $"The {nameof(ULongValueEvaluator)} does not support evaluation for the operator {operation}");
            }
        }
    }
}