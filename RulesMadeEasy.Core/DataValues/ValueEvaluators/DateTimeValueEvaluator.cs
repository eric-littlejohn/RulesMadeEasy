...
{
    /// <summary>
    /// An implementation of an <see cref="IValueEvaluator"/> for <see cref="DateTime"/>s
    /// </summary>
    public class DateTimeValueEvaluator : IValueEvaluator
    {
        /// <summary>
        ...
        {
            var valueA = (DateTime)objA;
            var valueB = (DateTime)objB;
            ...
            switch (operation)
            {
                ...
                default:
                    throw new ConditionEvaluationException(ConditionEvaluationException.ExceptionCause.UnsupportedOperator,
                        $"The {nameof(DateTimeValueEvaluator)} does not support evaluation for the operator {operation}");
            }
        }
    }
}