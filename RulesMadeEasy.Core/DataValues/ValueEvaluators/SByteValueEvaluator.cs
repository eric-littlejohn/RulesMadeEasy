...
{
    /// <summary>
    /// An implementation of an <see cref="IValueEvaluator"/> for <see cref="sbyte"/>s
    /// </summary>
    public class SByteValueEvaluator : IValueEvaluator
    {
        /// <summary>
        ...
        {
            sbyte valueA = (sbyte)objA;
            sbyte valueB = (sbyte)objB;
            ...
            switch (operation)
            {
                ...
                default:
                    throw new ConditionEvaluationException(ConditionEvaluationException.ExceptionCause.UnsupportedOperator,
                        $"The {nameof(SByteValueEvaluator)} does not support evaluation for the operator {operation}");
            }
        }
    }
}