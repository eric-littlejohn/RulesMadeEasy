...
{
    /// <summary>
    /// An implementation of an <see cref="IValueEvaluator"/> for <see cref="decimal"/>s
    /// </summary>
    public class DecimalValueEvaluator : IValueEvaluator
    {
        /// <summary>
        ...
        {
            var valueA = (decimal)objA;
            var valueB = (decimal)objB;
            ...
            switch (operation)
            {
                ...
                default:
                    throw new ConditionEvaluationException(ConditionEvaluationException.ExceptionCause.UnsupportedOperator,
                        $"The {nameof(DecimalValueEvaluator)} does not support evaluation for the operator {operation}");
            }
        }
    }
}